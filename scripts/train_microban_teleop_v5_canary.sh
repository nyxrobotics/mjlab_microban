...
# 501 completed updates materialize model_500.pt (checkpoint suffixes are
# zero-based) and stop before broadening the curriculum at iteration 1,000.
export MICROBAN_TELEOP_TARGET_ITERS="${MICROBAN_TELEOP_TARGET_ITERS:-501}"
